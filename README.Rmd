...
The main functions contained in the package reflect the typical workflow for the use of authorship verification methods for forensic problems:
...
4.  Run a verification function. At the moment the only implemented one is the *Impostors Method* in `impostors()`;
