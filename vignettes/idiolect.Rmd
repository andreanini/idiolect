...
4.  **Calibration**: Calibrate the output of (2) using the output of (1) into a Likelihood Ratio that expresses the strength of the evidence given the two competing hypotheses.
...
I would like to thank Shunichi Ishihara for helpful comments on the first draft of this vignette.
